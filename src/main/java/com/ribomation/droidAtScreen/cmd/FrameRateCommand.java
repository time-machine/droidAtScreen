...
public class FrameRateCommand extends Command {
  ...
  protected void doExecute(Application app) {
    ...
    JOptionPane.showMessageDialog(app.getAppFrame(), ratePane,
        "Screen-shot Frame Rate", JOptionPane.QUESTION_MESSAGE);
  }
  ...
  protected int getPreferenceValue() {
    return getApplication().getPreferences().getInt(getPreferencesKey(),
        FPS_INIT);
  }
  ...
  private JPanel createScalePane() {
    ...
    JSlider framesPerSecond = new JSlider(JSlider.HORIZONTAL, FPS_MIN, FPS_MAX,
        getPreferenceValue());
